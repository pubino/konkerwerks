    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for vendor in ["APPLE.COM/BILL", "GODADDY#4117118402"]:
                ...
                # 3. Expense Type (Click button first)
                type_btn = page.locator("button:has-text('Expense Type')").first
                if type_btn.count() > 0:
                    type_btn.click()
                    page.wait_for_timeout(2000)
                ...
                # 4. Justifications (Using confirmed IDs)
            ...
            logger.info("PRECISE UPDATES COMPLETED")
