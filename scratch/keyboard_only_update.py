    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            for vendor in ["APPLE.COM/BILL", "GODADDY#4117118402"]:
                logger.info(f"KEYBOARD UPDATING {vendor}...")
                ...
                logger.info(f"{vendor} KEYBOARD SAVED")
                
                # Deselect row
                checkbox.click(force=True)
                page.wait_for_timeout(2000)
            
            logger.info("ALL KEYBOARD UPDATES COMPLETED")
